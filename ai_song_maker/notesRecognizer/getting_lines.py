...
def preprocess_image(image):
    ...
    # Apply adaptive thresholding to highlight the lines
    # You may adjust these parameters based on your specific needs
...
def detect_lines(hough, image, nlines):
    ...
    if SAVING_IMAGES_STEPS:
        cv2.imwrite("../5lines.png", lines_image_color)
...
def get_staffs(image):
    ...
    hough = cv2.HoughLines(processed_image, 1, np.pi / 150, 100)
